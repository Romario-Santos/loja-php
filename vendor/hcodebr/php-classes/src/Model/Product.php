...
class Product extends Model
{
    ...
    {  
          //pega o nome do arquivo e faz um array com o nome e a extensão
        $extension = explode(".",$file["name"]);
        //pega a ultima posição do array que é a extensão
        $extension = end($extension);
    
        //verifica se a extensão é jpg,jpeg,png ou gif
        switch($extension)
        {
            case "jpg":
            case "jpeg":
